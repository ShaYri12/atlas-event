...
const FilterTwoEvents = () => {
    ...
    return (
        <section className='px-4 pt-[100px] pb-20'>
            <div className='max-w-[1660px] w-full mx-auto'>
                <h2 className='text-[#2D2C3C] font-bold text-2xl md:text-4xl pb-6 md:pb-10'>Custom Header/ Metadata Filter 1</h2>
                        ...
                        {events.slice(0, visibleEvents).map((event) => (
                            ...
                            >
                                ...
                                <div className="relative w-full h-48 md:h-[254px] bg-[#B9B9B9] flex items-center justify-center">
                                    ...
                                    <span className="text-sm md:text-lg leading-[24px] font-semibold text-white bg-[#2B293D] px-[10px] py-1 rounded-md absolute top-[14px] left-[14px]">
                                        {event.country}
                                    </span>
                                </div>
...
export default FilterTwoEvents
